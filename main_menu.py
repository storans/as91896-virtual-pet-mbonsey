...
if main_choice == 1:
    ...
    if 1.5 <= new_weight <= 2.5:
        continue_game = True
        print("{}'s weight is now {}!".format(rabbit_name, new_weight))
    else:
        if 1.5 > new_weight:
            print("I'm really sorry {}, but {} died because they were underweight. To keep your rabbit alive, they must be between 1.5kg and 2.5kg and {} was {}kg.".format(user_name, rabbit_name, rabbit_name, food_weight))
        if 2.5 < new_weight:
            print("I'm really sorry {}, but {} died because they were overweight. To keep your rabbit alive, they must be between 1.5kg and 2.5kg and {} was {}kg.".format(user_name, rabbit_name, rabbit_name, food_weight))
        continue_game = False
