...
def check_weight(new_weight):
    if 1.5 <= new_weight <= 2.5:
        ...
        if 1.5 > new_weight:
            print("I'm really sorry {}, but {} died because they were underweight. To keep your rabbit alive, they must be between 1.5kg and 2.5kg and {} was {:.2f}kg. Thanks for playing, we hope to see you again soon!".format(user_name, rabbit_name, rabbit_name, new_weight))
        if 2.5 < new_weight:
            print("I'm really sorry {}, but {} died because they were overweight. To keep your rabbit alive, they must be between 1.5kg and 2.5kg and {} was {:.2f}kg. Thanks for playing, we hope to see you again soon!".format(user_name, rabbit_name, rabbit_name, new_weight))
...
def restart():
    ...
    print("Hello, {}. Welcome to Virtual Pet! This game allows you to look after your very own pet rabbit that you can feed and exercise. Remember: The weight of your rabbit must stay above 1.5kg and below 2.5kg otherwise it will die.".format(user_name))
    print()
